...
- [x] **[P0] Clamp oversized result content**
...
- [x] **[P1] Strengthen left pane empty state**
...
- [x] **[P2] Improve modal focus separation**
...
- [x] **[P1] Fix detached toolbar controls**
...
- [x] **[P2] Clarify relationship between Settings tab and embedded Skills UI**
...
- [x] **[P2] Improve empty state clarity**
...
- [x] **[P2] Harmonize tab icon/text visual weights (`04`, `05`, `06`)**
