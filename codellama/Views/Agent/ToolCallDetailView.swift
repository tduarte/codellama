...
#Preview("With Result") {
    ToolCallDetailView(
        toolCall: ToolCall(
            ...
            toolName: "read_file",
            arguments: ["encoding": .string("utf-8"), "path": .string("/Users/user/project/README.md")]
        ),
        result: ToolResult(
            id: "result-1",
...
#Preview("Error Result") {
    ToolCallDetailView(
        toolCall: ToolCall(
            ...
            serverName: "github",
            toolName: "list_repos",
            arguments: ["owner": "anthropic"]
        ),
        result: ToolResult(
            id: "result-2",
            toolCallId: "call-xyz",
            content: "API rate limit exceeded. Reset at 2026-03-14T01:00:00Z.",
            isError: true
        )
    )
